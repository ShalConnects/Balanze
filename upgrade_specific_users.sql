-- =====================================================
-- MANUAL PREMIUM UPGRADE FOR SPECIFIC USERS
-- Upgrading users to premium without payment
-- =====================================================
...
-- Step 2: Upgrade both users to premium
UPDATE profiles 
SET subscription = jsonb_build_object(
    ...
    'manual_upgrade', jsonb_build_object(
...
SELECT 
    ...
    0.00 as amount_paid,
    'USD' as currency,
    'manual_upgrade' as payment_method
FROM profiles 
WHERE id IN (
    'd1fe3ccc-3c57-4621-866a-6d0643137d53',
    'cb3ac634-432d-4602-b2f9-3249702020d9'

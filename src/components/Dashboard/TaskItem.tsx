      ...
      {showActions && (
        ...
        >
          ...
          <button
            ...
            className="p-1.5 sm:p-0.5 text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors rounded min-w-[44px] min-h-[44px] md:min-w-0 md:min-h-0 flex items-center justify-center touch-manipulation"
            title="Edit task"
          >
          ...
          <button
            ...
            className="p-1.5 sm:p-0.5 text-gray-400 hover:text-red-600 dark:hover:text-red-400 transition-colors rounded min-w-[44px] min-h-[44px] md:min-w-0 md:min-h-0 flex items-center justify-center touch-manipulation"
            title="Delete task"
          >

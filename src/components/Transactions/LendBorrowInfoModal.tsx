...
interface LendBorrowInfoModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export const LendBorrowInfoModal: React.FC<LendBorrowInfoModalProps> = ({ isOpen, onClose }) => {
        ...
        <div className="p-6">
          <div className="text-gray-700 dark:text-gray-300 leading-relaxed">
             <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 text-center" style={{ marginTop: '20px' }}>
               ...
               <p className="font-medium text-blue-800 dark:text-blue-200 mb-3">Why is this transaction protected?</p>
               <div className="text-sm text-blue-800 dark:text-blue-200">
                 <p>
                   Lend & Borrow transactions are automatically created and managed to ensure 

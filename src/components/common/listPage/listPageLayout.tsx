...
export const LP = {
  ...
  /** Business investments summary — four stat cards, full-width row on large screens. */
  investmentSummaryGrid:
    'grid grid-cols-1 min-[400px]:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 lg:gap-4 p-2 sm:p-3 lg:p-4 min-w-0 overflow-hidden',

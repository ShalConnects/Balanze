...
export const ZakahPage: React.FC = () => {
  ...
  useEffect(() => {
    const next = syncCurrencyFilter(displayCurrency, availableCurrencies, getProfilePreferredCurrency(profile));
    if (next && next !== displayCurrency) setDisplayCurrency(next);
  }, [availableCurrencies, displayCurrency, profile]);

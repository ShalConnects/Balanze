        ...
        <div className="pt-16 bg-white dark:bg-gray-900 scroll-smooth font-manrope">
          <div className="w-4/5 mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg mb-8">
              ...
              <p className="mb-4">By using Balanze, you agree to these Terms of Service and our Privacy Policy. If you do not agree, please do not use the app.</p>
              ...
              <p className="mb-4">You may not use Balanze for any unlawful purpose, to harass others, or to attempt to gain unauthorized access to our systems.</p>
              <h2 className="text-2xl font-bold mb-4">4. Refund Policy</h2>
              <p className="mb-4">We offer a 14-day money-back guarantee for all Premium subscriptions. Refunds are processed within 3-5 business days. For detailed refund terms and conditions, please refer to our <a href="/refundpolicy" className="text-blue-600 hover:underline">Refund Policy</a>.</p>
              <h2 className="text-2xl font-bold mb-4">5. Disclaimer of Liability</h2>
              <p>Balanze is provided as-is without warranties of any kind. We are not liable for any damages or losses resulting from your use of the app.</p>
            </div>

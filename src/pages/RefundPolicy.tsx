          ...
          <div className="w-4/5 mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg mb-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    <strong>Contact Us:</strong> Send an email to <a href="mailto:shalconnect00@gmail.com" className="text-blue-600 hover:underline">shalconnect00@gmail.com</a> with the subject line "Refund Request".
                  </p>
                </div>
                <div className="flex items-start">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg mb-8">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                ...
                please don't hesitate to contact us at <a href="mailto:shalconnect00@gmail.com" className="text-blue-600 hover:underline">shalconnect00@gmail.com</a>. 
                We're here to help!
              </p>
            </div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    ...
                    <a href="mailto:shalconnect00@gmail.com" className="text-blue-600 hover:underline">shalconnect00@gmail.com</a>. 

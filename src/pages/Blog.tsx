      ...
      <div className="relative z-10">
        ...
        <div className="pt-16 bg-white dark:bg-gray-900 scroll-smooth font-manrope">
          <div className="w-4/5 mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <h1 className="text-5xl font-bold text-gray-900 dark:text-white mb-2 text-center">Balanze Blog</h1>
            <p className="text-center text-gray-600 dark:text-gray-400 mb-8">{articles.length} article{articles.length !== 1 ? 's' : ''}</p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {articles.map((article) => (
                <div key={article.slug} className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg flex flex-col">

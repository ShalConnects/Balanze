...
-- User Email: bebetteryou.motivational@gmail.com
...
WHERE p.id = 'fc0c4d30-fb4a-417c-a15f-305b580c6a7f'
   OR u.email = 'bebetteryou.motivational@gmail.com';
...
updated_at = NOW()
WHERE id = 'fc0c4d30-fb4a-417c-a15f-305b580c6a7f';
...
INSERT INTO subscription_history (
    ...
    'fc0c4d30-fb4a-417c-a15f-305b580c6a7f',
    'premium',
    'active',
    NOW(),
...
WHERE user_id = 'fc0c4d30-fb4a-417c-a15f-305b580c6a7f'
ORDER BY created_at DESC
LIMIT 5;

-- Success message
SELECT '=== UPGRADE COMPLETED ===' as info;
SELECT 'User bebetteryou.motivational@gmail.com has been upgraded to premium for 1 month' as result;

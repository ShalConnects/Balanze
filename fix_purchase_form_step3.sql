-- =====================================================
-- STEP 3: FIX PURCHASE FORM (SEPARATE FROM TRANSACTION LIMIT)
-- Ensure purchase form only checks purchase limit, not transaction limit
-- =====================================================

-- Step 1: Update the purchase limit check to be completely independent
...
BEGIN
    ...
    -- Count ALL existing purchases (lifetime) - completely independent of transactions
...
-- Step 2: Update the purchase limit enforcement to be completely independent
...
-- Step 4: Verification
SELECT 'STEP_3_COMPLETE' as status, 
       'Purchase form now only checks purchase limit, completely independent of transaction limit' as description;

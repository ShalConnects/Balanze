-- =====================================================
-- UPDATE ACCOUNT LIMIT FROM 5 TO 3
...
-- If subscription_plans table doesn't exist or free plan doesn't exist, create/insert it
INSERT INTO subscription_plans (name, price, currency, features, created_at, updated_at)
VALUES (
    'free',
    0.00,
    'USD',

-- Simplified function using only auth.users for email
-- Run this in Supabase SQL Editor

-- Drop and recreate the function with simplified structure
...
-- Success message
SELECT 'check_overdue_last_wish function simplified and working!' as status;
